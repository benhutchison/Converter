...
object AnonChildFactory {
  ...
  implicit sealed class Sugar (x: AnonChildFactory) {
    @scala.inline
    def duplicate: AnonChildFactory = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.reactTransitionGroup.AnonChildFactory]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): AnonChildFactory with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.reactTransitionGroup.AnonChildFactory with T]
    @scala.inline
    def withChildFactory(childFactory: /* child */ ReactElement => ReactElement): AnonChildFactory = {
      ...
      obj.asInstanceOf[typings.reactTransitionGroup.AnonChildFactory]
    }
  }
