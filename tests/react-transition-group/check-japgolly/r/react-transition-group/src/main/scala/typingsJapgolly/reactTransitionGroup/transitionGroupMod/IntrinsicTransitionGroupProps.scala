...
object IntrinsicTransitionGroupProps {
  ...
  implicit sealed class Sugar[T <: abbr | animate] (x: IntrinsicTransitionGroupProps[T]) {
    @scala.inline
    def duplicate: IntrinsicTransitionGroupProps[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsJapgolly.reactTransitionGroup.transitionGroupMod.IntrinsicTransitionGroupProps[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): IntrinsicTransitionGroupProps[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactTransitionGroup.transitionGroupMod.IntrinsicTransitionGroupProps[T] with T]
    @scala.inline
    def withComponent(component: T): IntrinsicTransitionGroupProps[T] = {
      ...
      obj.asInstanceOf[typingsJapgolly.reactTransitionGroup.transitionGroupMod.IntrinsicTransitionGroupProps[T]]
    }
  }
