...
object ContextMenuProps {
  ...
  implicit sealed class Sugar (x: ContextMenuProps) {
    @scala.inline
    def duplicate: ContextMenuProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.reactContextmenu.mod.ContextMenuProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): ContextMenuProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.reactContextmenu.mod.ContextMenuProps with T]
    @scala.inline
    def withId(id: String): ContextMenuProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(id = id.asInstanceOf[js.Any]), x).asInstanceOf[typingsSlinky.reactContextmenu.mod.ContextMenuProps]
    @scala.inline
    def withClassName(className: String): ContextMenuProps = {
      ...
      obj.asInstanceOf[typingsSlinky.reactContextmenu.mod.ContextMenuProps]
    }
    @scala.inline
