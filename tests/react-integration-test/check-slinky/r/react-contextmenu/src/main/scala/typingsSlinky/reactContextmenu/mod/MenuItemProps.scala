...
object MenuItemProps {
  ...
  implicit sealed class Sugar (x: MenuItemProps) {
    @scala.inline
    def duplicate: MenuItemProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.reactContextmenu.mod.MenuItemProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): MenuItemProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.reactContextmenu.mod.MenuItemProps with T]
    @scala.inline
    def withAttributes(attributes: HTMLAttributes[HTMLDivElement]): MenuItemProps = {
      ...
      obj.asInstanceOf[typingsSlinky.reactContextmenu.mod.MenuItemProps]
    }
    @scala.inline
