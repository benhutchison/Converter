...
object Mixin {
  ...
  @scala.inline
  implicit sealed class Sugar[P, S] (x: Mixin[P, S]) {
    @scala.inline
    def duplicate: Mixin[P, S] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.Mixin[P, S]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (Mixin[P, S]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.Mixin[P, S] with T]
    @scala.inline
    def withUNSAFE_componentWillMount(UNSAFE_componentWillMount: () => Unit): Mixin[P, S] = {
      ...
      obj.asInstanceOf[typingsSlinky.react.mod.Mixin[P, S]]
    }
    @scala.inline
    def withUNSAFE_componentWillReceiveProps(UNSAFE_componentWillReceiveProps: (P, /* nextContext */ js.Any) => Unit): Mixin[P, S] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withUNSAFE_componentWillUpdate(UNSAFE_componentWillUpdate: (P, S, /* nextContext */ js.Any) => Unit): Mixin[P, S] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withChildContextTypes(childContextTypes: ValidationMap[_]): Mixin[P, S] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
