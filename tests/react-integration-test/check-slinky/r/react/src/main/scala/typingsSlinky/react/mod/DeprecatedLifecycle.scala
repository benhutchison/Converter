...
object DeprecatedLifecycle {
  ...
  implicit sealed class Sugar[P, S] (x: DeprecatedLifecycle[P, S]) {
    @scala.inline
    def duplicate: DeprecatedLifecycle[P, S] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.DeprecatedLifecycle[P, S]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (DeprecatedLifecycle[P, S]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.DeprecatedLifecycle[P, S] with T]
    @scala.inline
    def withUNSAFE_componentWillMount(UNSAFE_componentWillMount: () => Unit): DeprecatedLifecycle[P, S] = {
      ...
      obj.asInstanceOf[typingsSlinky.react.mod.DeprecatedLifecycle[P, S]]
    }
    @scala.inline
