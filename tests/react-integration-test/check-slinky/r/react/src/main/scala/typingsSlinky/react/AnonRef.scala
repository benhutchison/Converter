...
object AnonRef {
  ...
  implicit sealed class Sugar (x: AnonRef) {
    @scala.inline
    def duplicate: AnonRef = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.AnonRef]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): AnonRef with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.AnonRef with T]
    @scala.inline
    def withRef(ref: /* import warning: importer.ImportType#apply Failed type conversion: infer R */ js.Any): AnonRef = {
      ...
      obj.asInstanceOf[typingsSlinky.react.AnonRef]
    }
  }
