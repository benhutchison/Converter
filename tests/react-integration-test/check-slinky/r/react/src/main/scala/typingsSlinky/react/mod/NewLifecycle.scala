...
object NewLifecycle {
  ...
  implicit sealed class Sugar[P, S, SS] (x: NewLifecycle[P, S, SS]) {
    @scala.inline
    def duplicate: NewLifecycle[P, S, SS] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.NewLifecycle[P, S, SS]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (NewLifecycle[P, S, SS]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.NewLifecycle[P, S, SS] with T]
    @scala.inline
    def withComponentDidUpdate(componentDidUpdate: (/* prevProps */ P, /* prevState */ S, /* snapshot */ js.UndefOr[SS]) => Unit): NewLifecycle[P, S, SS] = {
      ...
      obj.asInstanceOf[typingsSlinky.react.mod.NewLifecycle[P, S, SS]]
    }
    @scala.inline
