...
object ComponentLifecycle {
  ...
  implicit sealed class Sugar[P, S, SS] (x: ComponentLifecycle[P, S, SS]) {
    @scala.inline
    def duplicate: ComponentLifecycle[P, S, SS] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.ComponentLifecycle[P, S, SS]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (ComponentLifecycle[P, S, SS]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.ComponentLifecycle[P, S, SS] with T]
    @scala.inline
    def withUNSAFE_componentWillMount(UNSAFE_componentWillMount: () => Unit): ComponentLifecycle[P, S, SS] = {
      ...
      obj.asInstanceOf[typingsSlinky.react.mod.ComponentLifecycle[P, S, SS]]
    }
    @scala.inline
