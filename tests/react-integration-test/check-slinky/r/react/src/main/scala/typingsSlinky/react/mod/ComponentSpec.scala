...
object ComponentSpec {
  ...
  implicit sealed class Sugar[P, S] (x: ComponentSpec[P, S]) {
    @scala.inline
    def duplicate: ComponentSpec[P, S] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.ComponentSpec[P, S]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (ComponentSpec[P, S]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.ComponentSpec[P, S] with T]
    @scala.inline
    def withRender(render: () => TagMod[Any]): ComponentSpec[P, S] = js.Dynamic.global.Object.assign(js.Dynamic.literal(render = js.Any.fromFunction0(render)), x).asInstanceOf[typingsSlinky.react.mod.ComponentSpec[P, S]]
    @scala.inline
    def withStringDictionary(StringDictionary: /* propertyName */ StringDictionary[js.Any]): ComponentSpec[P, S] = {
      ...
      obj.asInstanceOf[typingsSlinky.react.mod.ComponentSpec[P, S]]
    }
    @scala.inline
