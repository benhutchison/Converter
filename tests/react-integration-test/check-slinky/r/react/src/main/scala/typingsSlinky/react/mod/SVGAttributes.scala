...
object SVGAttributes {
  ...
  implicit sealed class Sugar[T] (x: SVGAttributes[T]) {
    @scala.inline
    def duplicate: SVGAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.SVGAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): SVGAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.SVGAttributes[T] with T]
    @scala.inline
    def withAriaAttributes(AriaAttributes: AriaAttributes): SVGAttributes[T] = {
      ...
      obj.asInstanceOf[typingsSlinky.react.mod.SVGAttributes[T]]
    }
    @scala.inline
