...
object StaticLifecycle {
  ...
  implicit sealed class Sugar[P, S] (x: StaticLifecycle[P, S]) {
    @scala.inline
    def duplicate: StaticLifecycle[P, S] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.StaticLifecycle[P, S]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (StaticLifecycle[P, S]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.StaticLifecycle[P, S] with T]
    @scala.inline
    def withGetDerivedStateFromError(getDerivedStateFromError: /* error */ js.Any => Partial[S] | Null): StaticLifecycle[P, S] = {
      ...
      obj.asInstanceOf[typingsSlinky.react.mod.StaticLifecycle[P, S]]
    }
    @scala.inline
