...
object DOMElement {
  ...
  implicit sealed class Sugar[P <: HTMLAttributes[T] | SVGAttributes[T], T <: Element] (x: DOMElement[P, T]) {
    @scala.inline
    def duplicate: DOMElement[P, T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.react.mod.DOMElement[P, T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (DOMElement[P, T]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.react.mod.DOMElement[P, T] with T]
    @scala.inline
    def withProps(props: js.Any): DOMElement[P, T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(props = props.asInstanceOf[js.Any]), x).asInstanceOf[typingsSlinky.react.mod.DOMElement[P, T]]
    @scala.inline
    def withType(`type`: js.Any): DOMElement[P, T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      obj.asInstanceOf[typingsSlinky.react.mod.DOMElement[P, T]]
    }
    @scala.inline
