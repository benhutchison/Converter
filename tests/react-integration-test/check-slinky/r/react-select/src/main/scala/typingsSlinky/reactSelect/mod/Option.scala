...
object Option {
  ...
  implicit sealed class Sugar[TValue] (x: Option[TValue]) {
    @scala.inline
    def duplicate: Option[TValue] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.reactSelect.mod.Option[TValue]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): Option[TValue] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.reactSelect.mod.Option[TValue] with T]
    @scala.inline
    ...
    /* property */ StringDictionary[js.Any]
      ...
      obj.asInstanceOf[typingsSlinky.reactSelect.mod.Option[TValue]]
    }
    @scala.inline
