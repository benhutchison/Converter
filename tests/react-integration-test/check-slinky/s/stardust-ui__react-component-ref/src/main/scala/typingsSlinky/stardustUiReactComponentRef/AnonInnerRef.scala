...
object AnonInnerRef {
  ...
  implicit sealed class Sugar (x: AnonInnerRef) {
    @scala.inline
    def duplicate: AnonInnerRef = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.stardustUiReactComponentRef.AnonInnerRef]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): AnonInnerRef with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.stardustUiReactComponentRef.AnonInnerRef with T]
    @scala.inline
    def withChildrenUndefined: AnonInnerRef = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      js.special.delete(obj, "children")
      obj.asInstanceOf[typingsSlinky.stardustUiReactComponentRef.AnonInnerRef]
    }
    @scala.inline
