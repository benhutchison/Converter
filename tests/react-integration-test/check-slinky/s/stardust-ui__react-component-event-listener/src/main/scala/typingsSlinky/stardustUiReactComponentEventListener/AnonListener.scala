...
object AnonListener {
  ...
  implicit sealed class Sugar (x: AnonListener) {
    @scala.inline
    def duplicate: AnonListener = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.stardustUiReactComponentEventListener.AnonListener]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): AnonListener with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.stardustUiReactComponentEventListener.AnonListener with T]
    @scala.inline
    def withCaptureUndefined: AnonListener = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      js.special.delete(obj, "capture")
      obj.asInstanceOf[typingsSlinky.stardustUiReactComponentEventListener.AnonListener]
    }
    @scala.inline
