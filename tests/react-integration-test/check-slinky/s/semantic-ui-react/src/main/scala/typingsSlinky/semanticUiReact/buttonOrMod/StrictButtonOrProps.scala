...
object StrictButtonOrProps {
  ...
  implicit sealed class Sugar (x: StrictButtonOrProps) {
    @scala.inline
    def duplicate: StrictButtonOrProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.semanticUiReact.buttonOrMod.StrictButtonOrProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): StrictButtonOrProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.semanticUiReact.buttonOrMod.StrictButtonOrProps with T]
    @scala.inline
    def withAs(as: js.Any): StrictButtonOrProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (as != null) obj.updateDynamic("as")(as.asInstanceOf[js.Any])
      obj.asInstanceOf[typingsSlinky.semanticUiReact.buttonOrMod.StrictButtonOrProps]
    }
    @scala.inline
