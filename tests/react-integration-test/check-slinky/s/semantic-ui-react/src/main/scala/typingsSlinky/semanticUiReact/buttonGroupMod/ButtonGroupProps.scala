...
object ButtonGroupProps {
  ...
  implicit sealed class Sugar (x: ButtonGroupProps) {
    @scala.inline
    def duplicate: ButtonGroupProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.semanticUiReact.buttonGroupMod.ButtonGroupProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): ButtonGroupProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.semanticUiReact.buttonGroupMod.ButtonGroupProps with T]
    @scala.inline
    def withStringDictionary(StringDictionary: /* key */ StringDictionary[js.Any]): ButtonGroupProps = {
      ...
      obj.asInstanceOf[typingsSlinky.semanticUiReact.buttonGroupMod.ButtonGroupProps]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: TagMod[Any]): ButtonGroupProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
