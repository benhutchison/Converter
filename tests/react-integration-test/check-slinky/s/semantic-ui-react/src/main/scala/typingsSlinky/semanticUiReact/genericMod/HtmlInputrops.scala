...
object HtmlInputrops {
  ...
  implicit sealed class Sugar (x: HtmlInputrops) {
    @scala.inline
    def duplicate: HtmlInputrops = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.semanticUiReact.genericMod.HtmlInputrops]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): HtmlInputrops with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.semanticUiReact.genericMod.HtmlInputrops with T]
    @scala.inline
    def withStringDictionary(StringDictionary: /* key */ StringDictionary[js.Any]): HtmlInputrops = {
      ...
      obj.asInstanceOf[typingsSlinky.semanticUiReact.genericMod.HtmlInputrops]
    }
    @scala.inline
