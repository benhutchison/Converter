...
object StrictAccordionContentProps {
  ...
  implicit sealed class Sugar (x: StrictAccordionContentProps) {
    @scala.inline
    def duplicate: StrictAccordionContentProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typingsSlinky.semanticUiReact.accordionContentMod.StrictAccordionContentProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): StrictAccordionContentProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.semanticUiReact.accordionContentMod.StrictAccordionContentProps with T]
    @scala.inline
    def withActiveUndefined: StrictAccordionContentProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      js.special.delete(obj, "active")
      obj.asInstanceOf[typingsSlinky.semanticUiReact.accordionContentMod.StrictAccordionContentProps]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: TagMod[Any]): StrictAccordionContentProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
