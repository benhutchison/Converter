...
object SubMenuProps {
  ...
  implicit sealed class Sugar (x: SubMenuProps) {
    @scala.inline
    def duplicate: SubMenuProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.reactContextmenu.mod.SubMenuProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): SubMenuProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.reactContextmenu.mod.SubMenuProps with T]
    @scala.inline
    def withTitleReactElement(title: ReactElement): SubMenuProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(title = title.asInstanceOf[js.Any]), x).asInstanceOf[typings.reactContextmenu.mod.SubMenuProps]
    @scala.inline
    def withTitleReactText(title: ReactText): SubMenuProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(title = title.asInstanceOf[js.Any]), x).asInstanceOf[typings.reactContextmenu.mod.SubMenuProps]
    @scala.inline
    def withClassName(className: String): SubMenuProps = {
      ...
      obj.asInstanceOf[typings.reactContextmenu.mod.SubMenuProps]
    }
    @scala.inline
