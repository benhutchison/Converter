...
object DropzoneOptions {
  ...
  implicit sealed class Sugar (x: DropzoneOptions) {
    @scala.inline
    def duplicate: DropzoneOptions = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.reactDropzone.mod.DropzoneOptions]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): DropzoneOptions with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.reactDropzone.mod.DropzoneOptions with T]
    @scala.inline
    def withAcceptArray(accept: js.Array[String]): DropzoneOptions = {
      ...
      obj.asInstanceOf[typings.reactDropzone.mod.DropzoneOptions]
    }
    @scala.inline
