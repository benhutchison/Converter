...
object CheckboxProps {
  ...
  implicit sealed class Sugar (x: CheckboxProps) {
    @scala.inline
    def duplicate: CheckboxProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.reactBootstrap.toggleButtonGroupMod.CheckboxProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): CheckboxProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.reactBootstrap.toggleButtonGroupMod.CheckboxProps with T]
    @scala.inline
    def withType(`type`: checkbox): CheckboxProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.reactBootstrap.toggleButtonGroupMod.CheckboxProps]
    }
    @scala.inline
