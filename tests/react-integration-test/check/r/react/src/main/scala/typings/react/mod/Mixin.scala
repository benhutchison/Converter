...
object Mixin {
  ...
  implicit sealed class Sugar[P, S] (x: Mixin[P, S]) {
    @scala.inline
    def duplicate: Mixin[P, S] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.Mixin[P, S]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (Mixin[P, S]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.Mixin[P, S] with T]
    @scala.inline
    def withUNSAFE_componentWillMount(UNSAFE_componentWillMount: () => Unit): Mixin[P, S] = {
      ...
      obj.asInstanceOf[typings.react.mod.Mixin[P, S]]
    }
    @scala.inline
