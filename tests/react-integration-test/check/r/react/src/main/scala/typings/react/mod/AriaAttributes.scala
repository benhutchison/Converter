...
object AriaAttributes {
  ...
  implicit sealed class Sugar (x: AriaAttributes) {
    @scala.inline
    def duplicate: AriaAttributes = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.AriaAttributes]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): AriaAttributes with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.AriaAttributes with T]
    @scala.inline
    def `withAria-activedescendant`(`aria-activedescendant`: String): AriaAttributes = {
      ...
      obj.asInstanceOf[typings.react.mod.AriaAttributes]
    }
    @scala.inline
