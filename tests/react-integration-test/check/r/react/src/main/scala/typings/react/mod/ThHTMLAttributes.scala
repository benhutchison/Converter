...
object ThHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: ThHTMLAttributes[T]) {
    @scala.inline
    def duplicate: ThHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.ThHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): ThHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.ThHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): ThHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.ThHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): ThHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
