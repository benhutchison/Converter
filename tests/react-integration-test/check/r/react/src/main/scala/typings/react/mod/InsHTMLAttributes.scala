...
object InsHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: InsHTMLAttributes[T]) {
    @scala.inline
    def duplicate: InsHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.InsHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): InsHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.InsHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): InsHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.InsHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): InsHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
