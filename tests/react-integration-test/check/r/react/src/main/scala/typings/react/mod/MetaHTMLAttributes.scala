...
object MetaHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: MetaHTMLAttributes[T]) {
    @scala.inline
    def duplicate: MetaHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.MetaHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): MetaHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.MetaHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): MetaHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.MetaHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): MetaHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
