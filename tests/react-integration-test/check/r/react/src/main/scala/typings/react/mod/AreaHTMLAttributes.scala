...
object AreaHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: AreaHTMLAttributes[T]) {
    @scala.inline
    def duplicate: AreaHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.AreaHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): AreaHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.AreaHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): AreaHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.AreaHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): AreaHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
