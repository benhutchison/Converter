...
object TdHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: TdHTMLAttributes[T]) {
    @scala.inline
    def duplicate: TdHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.TdHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): TdHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.TdHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): TdHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.TdHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): TdHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
