...
object ColHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: ColHTMLAttributes[T]) {
    @scala.inline
    def duplicate: ColHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.ColHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): ColHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.ColHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): ColHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.ColHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): ColHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
