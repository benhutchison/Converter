...
object TimeHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: TimeHTMLAttributes[T]) {
    @scala.inline
    def duplicate: TimeHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.TimeHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): TimeHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.TimeHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): TimeHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.TimeHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): TimeHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
