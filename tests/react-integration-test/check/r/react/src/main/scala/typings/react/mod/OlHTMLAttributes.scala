...
object OlHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: OlHTMLAttributes[T]) {
    @scala.inline
    def duplicate: OlHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.OlHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): OlHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.OlHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): OlHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.OlHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): OlHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
