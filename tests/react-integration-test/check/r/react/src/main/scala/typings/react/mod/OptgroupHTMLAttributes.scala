...
object OptgroupHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: OptgroupHTMLAttributes[T]) {
    @scala.inline
    def duplicate: OptgroupHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): OptgroupHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): OptgroupHTMLAttributes[T] = {
      ...
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withOnAbort(onAbort: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAbort != null) obj.updateDynamic("onAbort")(js.Any.fromFunction1(onAbort))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnAnimationEnd(onAnimationEnd: AnimationEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAnimationEnd != null) obj.updateDynamic("onAnimationEnd")(js.Any.fromFunction1(onAnimationEnd))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnAnimationIteration(onAnimationIteration: AnimationEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAnimationIteration != null) obj.updateDynamic("onAnimationIteration")(js.Any.fromFunction1(onAnimationIteration))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnAnimationStart(onAnimationStart: AnimationEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAnimationStart != null) obj.updateDynamic("onAnimationStart")(js.Any.fromFunction1(onAnimationStart))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnAuxClick(onAuxClick: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAuxClick != null) obj.updateDynamic("onAuxClick")(js.Any.fromFunction1(onAuxClick))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnBeforeInput(onBeforeInput: FormEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onBeforeInput != null) obj.updateDynamic("onBeforeInput")(js.Any.fromFunction1(onBeforeInput))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnBlur(onBlur: FocusEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onBlur != null) obj.updateDynamic("onBlur")(js.Any.fromFunction1(onBlur))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnCanPlay(onCanPlay: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCanPlay != null) obj.updateDynamic("onCanPlay")(js.Any.fromFunction1(onCanPlay))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnCanPlayThrough(onCanPlayThrough: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCanPlayThrough != null) obj.updateDynamic("onCanPlayThrough")(js.Any.fromFunction1(onCanPlayThrough))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnChange(onChange: FormEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onChange != null) obj.updateDynamic("onChange")(js.Any.fromFunction1(onChange))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnClick(onClick: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onClick != null) obj.updateDynamic("onClick")(js.Any.fromFunction1(onClick))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnCompositionEnd(onCompositionEnd: CompositionEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCompositionEnd != null) obj.updateDynamic("onCompositionEnd")(js.Any.fromFunction1(onCompositionEnd))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnCompositionStart(onCompositionStart: CompositionEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCompositionStart != null) obj.updateDynamic("onCompositionStart")(js.Any.fromFunction1(onCompositionStart))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnCompositionUpdate(onCompositionUpdate: CompositionEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCompositionUpdate != null) obj.updateDynamic("onCompositionUpdate")(js.Any.fromFunction1(onCompositionUpdate))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnContextMenu(onContextMenu: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onContextMenu != null) obj.updateDynamic("onContextMenu")(js.Any.fromFunction1(onContextMenu))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnCopy(onCopy: ClipboardEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCopy != null) obj.updateDynamic("onCopy")(js.Any.fromFunction1(onCopy))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnCut(onCut: ClipboardEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCut != null) obj.updateDynamic("onCut")(js.Any.fromFunction1(onCut))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnDoubleClick(onDoubleClick: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withOnDurationChange(onDurationChange: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDurationChange != null) obj.updateDynamic("onDurationChange")(js.Any.fromFunction1(onDurationChange))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnEmptied(onEmptied: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onEmptied != null) obj.updateDynamic("onEmptied")(js.Any.fromFunction1(onEmptied))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnEncrypted(onEncrypted: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onEncrypted != null) obj.updateDynamic("onEncrypted")(js.Any.fromFunction1(onEncrypted))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnEnded(onEnded: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onEnded != null) obj.updateDynamic("onEnded")(js.Any.fromFunction1(onEnded))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnError(onError: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onError != null) obj.updateDynamic("onError")(js.Any.fromFunction1(onError))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnFocus(onFocus: FocusEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onFocus != null) obj.updateDynamic("onFocus")(js.Any.fromFunction1(onFocus))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnInput(onInput: FormEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onInput != null) obj.updateDynamic("onInput")(js.Any.fromFunction1(onInput))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnInvalid(onInvalid: FormEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onInvalid != null) obj.updateDynamic("onInvalid")(js.Any.fromFunction1(onInvalid))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnKeyDown(onKeyDown: KeyboardEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onKeyDown != null) obj.updateDynamic("onKeyDown")(js.Any.fromFunction1(onKeyDown))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnKeyPress(onKeyPress: KeyboardEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onKeyPress != null) obj.updateDynamic("onKeyPress")(js.Any.fromFunction1(onKeyPress))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnKeyUp(onKeyUp: KeyboardEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onKeyUp != null) obj.updateDynamic("onKeyUp")(js.Any.fromFunction1(onKeyUp))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnLoad(onLoad: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoad != null) obj.updateDynamic("onLoad")(js.Any.fromFunction1(onLoad))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnLoadStart(onLoadStart: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoadStart != null) obj.updateDynamic("onLoadStart")(js.Any.fromFunction1(onLoadStart))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnLoadedData(onLoadedData: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoadedData != null) obj.updateDynamic("onLoadedData")(js.Any.fromFunction1(onLoadedData))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnLoadedMetadata(onLoadedMetadata: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoadedMetadata != null) obj.updateDynamic("onLoadedMetadata")(js.Any.fromFunction1(onLoadedMetadata))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnMouseDown(onMouseDown: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseDown != null) obj.updateDynamic("onMouseDown")(js.Any.fromFunction1(onMouseDown))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnMouseEnter(onMouseEnter: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseEnter != null) obj.updateDynamic("onMouseEnter")(js.Any.fromFunction1(onMouseEnter))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnMouseLeave(onMouseLeave: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseLeave != null) obj.updateDynamic("onMouseLeave")(js.Any.fromFunction1(onMouseLeave))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnMouseMove(onMouseMove: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseMove != null) obj.updateDynamic("onMouseMove")(js.Any.fromFunction1(onMouseMove))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnMouseOut(onMouseOut: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseOut != null) obj.updateDynamic("onMouseOut")(js.Any.fromFunction1(onMouseOut))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnMouseOver(onMouseOver: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseOver != null) obj.updateDynamic("onMouseOver")(js.Any.fromFunction1(onMouseOver))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnMouseUp(onMouseUp: MouseEvent[T, NativeMouseEvent] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseUp != null) obj.updateDynamic("onMouseUp")(js.Any.fromFunction1(onMouseUp))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPaste(onPaste: ClipboardEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPaste != null) obj.updateDynamic("onPaste")(js.Any.fromFunction1(onPaste))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPause(onPause: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPause != null) obj.updateDynamic("onPause")(js.Any.fromFunction1(onPause))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPlay(onPlay: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPlay != null) obj.updateDynamic("onPlay")(js.Any.fromFunction1(onPlay))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPlaying(onPlaying: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPlaying != null) obj.updateDynamic("onPlaying")(js.Any.fromFunction1(onPlaying))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerCancel(onPointerCancel: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerCancel != null) obj.updateDynamic("onPointerCancel")(js.Any.fromFunction1(onPointerCancel))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerDown(onPointerDown: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerDown != null) obj.updateDynamic("onPointerDown")(js.Any.fromFunction1(onPointerDown))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerEnter(onPointerEnter: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerEnter != null) obj.updateDynamic("onPointerEnter")(js.Any.fromFunction1(onPointerEnter))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerLeave(onPointerLeave: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerLeave != null) obj.updateDynamic("onPointerLeave")(js.Any.fromFunction1(onPointerLeave))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerMove(onPointerMove: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerMove != null) obj.updateDynamic("onPointerMove")(js.Any.fromFunction1(onPointerMove))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerOut(onPointerOut: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerOut != null) obj.updateDynamic("onPointerOut")(js.Any.fromFunction1(onPointerOut))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerOver(onPointerOver: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerOver != null) obj.updateDynamic("onPointerOver")(js.Any.fromFunction1(onPointerOver))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnPointerUp(onPointerUp: PointerEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerUp != null) obj.updateDynamic("onPointerUp")(js.Any.fromFunction1(onPointerUp))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnProgress(onProgress: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onProgress != null) obj.updateDynamic("onProgress")(js.Any.fromFunction1(onProgress))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnRateChange(onRateChange: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onRateChange != null) obj.updateDynamic("onRateChange")(js.Any.fromFunction1(onRateChange))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnReset(onReset: FormEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onReset != null) obj.updateDynamic("onReset")(js.Any.fromFunction1(onReset))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnScroll(onScroll: UIEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onScroll != null) obj.updateDynamic("onScroll")(js.Any.fromFunction1(onScroll))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnSeeked(onSeeked: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSeeked != null) obj.updateDynamic("onSeeked")(js.Any.fromFunction1(onSeeked))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnSeeking(onSeeking: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSeeking != null) obj.updateDynamic("onSeeking")(js.Any.fromFunction1(onSeeking))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnSelect(onSelect: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSelect != null) obj.updateDynamic("onSelect")(js.Any.fromFunction1(onSelect))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnStalled(onStalled: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onStalled != null) obj.updateDynamic("onStalled")(js.Any.fromFunction1(onStalled))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnSubmit(onSubmit: FormEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSubmit != null) obj.updateDynamic("onSubmit")(js.Any.fromFunction1(onSubmit))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnSuspend(onSuspend: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSuspend != null) obj.updateDynamic("onSuspend")(js.Any.fromFunction1(onSuspend))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnTimeUpdate(onTimeUpdate: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTimeUpdate != null) obj.updateDynamic("onTimeUpdate")(js.Any.fromFunction1(onTimeUpdate))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnTouchCancel(onTouchCancel: TouchEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchCancel != null) obj.updateDynamic("onTouchCancel")(js.Any.fromFunction1(onTouchCancel))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnTouchEnd(onTouchEnd: TouchEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchEnd != null) obj.updateDynamic("onTouchEnd")(js.Any.fromFunction1(onTouchEnd))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnTouchMove(onTouchMove: TouchEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchMove != null) obj.updateDynamic("onTouchMove")(js.Any.fromFunction1(onTouchMove))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnTouchStart(onTouchStart: TouchEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchStart != null) obj.updateDynamic("onTouchStart")(js.Any.fromFunction1(onTouchStart))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnTransitionEnd(onTransitionEnd: TransitionEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTransitionEnd != null) obj.updateDynamic("onTransitionEnd")(js.Any.fromFunction1(onTransitionEnd))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnVolumeChange(onVolumeChange: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onVolumeChange != null) obj.updateDynamic("onVolumeChange")(js.Any.fromFunction1(onVolumeChange))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnWaiting(onWaiting: SyntheticEvent[T, Event] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onWaiting != null) obj.updateDynamic("onWaiting")(js.Any.fromFunction1(onWaiting))
      obj.asInstanceOf[typings.react.mod.OptgroupHTMLAttributes[T]]
    }
    @scala.inline
    def withOnWheel(onWheel: WheelEvent[T] => Unit): OptgroupHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
