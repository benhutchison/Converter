...
object MapHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: MapHTMLAttributes[T]) {
    @scala.inline
    def duplicate: MapHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.MapHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): MapHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.MapHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): MapHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.MapHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): MapHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
