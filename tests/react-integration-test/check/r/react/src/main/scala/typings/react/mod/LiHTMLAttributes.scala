...
object LiHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: LiHTMLAttributes[T]) {
    @scala.inline
    def duplicate: LiHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.LiHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): LiHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.LiHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): LiHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.LiHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): LiHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
