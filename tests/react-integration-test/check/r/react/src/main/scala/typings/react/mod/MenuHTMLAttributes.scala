...
object MenuHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: MenuHTMLAttributes[T]) {
    @scala.inline
    def duplicate: MenuHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.MenuHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): MenuHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.MenuHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): MenuHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.MenuHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): MenuHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
