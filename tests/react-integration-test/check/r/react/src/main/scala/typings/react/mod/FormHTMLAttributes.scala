...
object FormHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: FormHTMLAttributes[T]) {
    @scala.inline
    def duplicate: FormHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.FormHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): FormHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.FormHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): FormHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.FormHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): FormHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
