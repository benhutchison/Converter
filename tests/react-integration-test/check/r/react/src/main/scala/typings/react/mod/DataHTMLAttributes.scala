...
object DataHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: DataHTMLAttributes[T]) {
    @scala.inline
    def duplicate: DataHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.DataHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): DataHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.DataHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): DataHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.DataHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): DataHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
