...
object DelHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: DelHTMLAttributes[T]) {
    @scala.inline
    def duplicate: DelHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.DelHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): DelHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.DelHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): DelHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.DelHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): DelHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
