...
object HtmlHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: HtmlHTMLAttributes[T]) {
    @scala.inline
    def duplicate: HtmlHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.HtmlHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): HtmlHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.HtmlHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): HtmlHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.HtmlHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): HtmlHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
