...
object DetailedReactHTMLElement {
  ...
  implicit sealed class Sugar[P <: HTMLAttributes[T], T <: HTMLElement] (x: DetailedReactHTMLElement[P, T]) {
    @scala.inline
    def duplicate: DetailedReactHTMLElement[P, T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.DetailedReactHTMLElement[P, T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): (DetailedReactHTMLElement[P, T]) with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.DetailedReactHTMLElement[P, T] with T]
    @scala.inline
    def withProps(props: js.Any): DetailedReactHTMLElement[P, T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(props = props.asInstanceOf[js.Any]), x).asInstanceOf[typings.react.mod.DetailedReactHTMLElement[P, T]]
    @scala.inline
    def withType(`type`: js.Any): DetailedReactHTMLElement[P, T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.DetailedReactHTMLElement[P, T]]
    }
    @scala.inline
