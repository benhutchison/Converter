...
object LinkHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: LinkHTMLAttributes[T]) {
    @scala.inline
    def duplicate: LinkHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.LinkHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): LinkHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.LinkHTMLAttributes[T] with T]
    @scala.inline
    def withAbout(about: String): LinkHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.react.mod.LinkHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): LinkHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
