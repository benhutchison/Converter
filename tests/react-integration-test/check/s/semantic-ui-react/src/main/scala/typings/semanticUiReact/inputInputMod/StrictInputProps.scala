...
object StrictInputProps {
  ...
  implicit sealed class Sugar (x: StrictInputProps) {
    @scala.inline
    def duplicate: StrictInputProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): StrictInputProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps with T]
    @scala.inline
    def withAbout(about: String): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withOnAbort(onAbort: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAbort != null) obj.updateDynamic("onAbort")(js.Any.fromFunction1(onAbort))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnAnimationEnd(onAnimationEnd: AnimationEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAnimationEnd != null) obj.updateDynamic("onAnimationEnd")(js.Any.fromFunction1(onAnimationEnd))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnAnimationIteration(onAnimationIteration: AnimationEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAnimationIteration != null) obj.updateDynamic("onAnimationIteration")(js.Any.fromFunction1(onAnimationIteration))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnAnimationStart(onAnimationStart: AnimationEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAnimationStart != null) obj.updateDynamic("onAnimationStart")(js.Any.fromFunction1(onAnimationStart))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnAuxClick(onAuxClick: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onAuxClick != null) obj.updateDynamic("onAuxClick")(js.Any.fromFunction1(onAuxClick))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnBeforeInput(onBeforeInput: FormEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onBeforeInput != null) obj.updateDynamic("onBeforeInput")(js.Any.fromFunction1(onBeforeInput))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnBlur(onBlur: FocusEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onBlur != null) obj.updateDynamic("onBlur")(js.Any.fromFunction1(onBlur))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnCanPlay(onCanPlay: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCanPlay != null) obj.updateDynamic("onCanPlay")(js.Any.fromFunction1(onCanPlay))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnCanPlayThrough(onCanPlayThrough: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCanPlayThrough != null) obj.updateDynamic("onCanPlayThrough")(js.Any.fromFunction1(onCanPlayThrough))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnChange(onChange: (/* event */ ChangeEvent[HTMLInputElement], /* data */ InputOnChangeData) => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onChange != null) obj.updateDynamic("onChange")(js.Any.fromFunction2(onChange))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnClick(onClick: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onClick != null) obj.updateDynamic("onClick")(js.Any.fromFunction1(onClick))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnCompositionEnd(onCompositionEnd: CompositionEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCompositionEnd != null) obj.updateDynamic("onCompositionEnd")(js.Any.fromFunction1(onCompositionEnd))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnCompositionStart(onCompositionStart: CompositionEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCompositionStart != null) obj.updateDynamic("onCompositionStart")(js.Any.fromFunction1(onCompositionStart))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnCompositionUpdate(onCompositionUpdate: CompositionEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCompositionUpdate != null) obj.updateDynamic("onCompositionUpdate")(js.Any.fromFunction1(onCompositionUpdate))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnContextMenu(onContextMenu: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onContextMenu != null) obj.updateDynamic("onContextMenu")(js.Any.fromFunction1(onContextMenu))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnCopy(onCopy: ClipboardEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCopy != null) obj.updateDynamic("onCopy")(js.Any.fromFunction1(onCopy))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnCut(onCut: ClipboardEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onCut != null) obj.updateDynamic("onCut")(js.Any.fromFunction1(onCut))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDoubleClick(onDoubleClick: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDoubleClick != null) obj.updateDynamic("onDoubleClick")(js.Any.fromFunction1(onDoubleClick))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDrag(onDrag: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDrag != null) obj.updateDynamic("onDrag")(js.Any.fromFunction1(onDrag))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDragEnd(onDragEnd: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDragEnd != null) obj.updateDynamic("onDragEnd")(js.Any.fromFunction1(onDragEnd))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDragEnter(onDragEnter: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDragEnter != null) obj.updateDynamic("onDragEnter")(js.Any.fromFunction1(onDragEnter))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDragExit(onDragExit: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDragExit != null) obj.updateDynamic("onDragExit")(js.Any.fromFunction1(onDragExit))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDragLeave(onDragLeave: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDragLeave != null) obj.updateDynamic("onDragLeave")(js.Any.fromFunction1(onDragLeave))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDragOver(onDragOver: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDragOver != null) obj.updateDynamic("onDragOver")(js.Any.fromFunction1(onDragOver))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDragStart(onDragStart: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDragStart != null) obj.updateDynamic("onDragStart")(js.Any.fromFunction1(onDragStart))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDrop(onDrop: DragEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDrop != null) obj.updateDynamic("onDrop")(js.Any.fromFunction1(onDrop))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnDurationChange(onDurationChange: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onDurationChange != null) obj.updateDynamic("onDurationChange")(js.Any.fromFunction1(onDurationChange))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnEmptied(onEmptied: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onEmptied != null) obj.updateDynamic("onEmptied")(js.Any.fromFunction1(onEmptied))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnEncrypted(onEncrypted: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onEncrypted != null) obj.updateDynamic("onEncrypted")(js.Any.fromFunction1(onEncrypted))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnEnded(onEnded: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onEnded != null) obj.updateDynamic("onEnded")(js.Any.fromFunction1(onEnded))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnError(onError: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onError != null) obj.updateDynamic("onError")(js.Any.fromFunction1(onError))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnFocus(onFocus: FocusEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onFocus != null) obj.updateDynamic("onFocus")(js.Any.fromFunction1(onFocus))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnInput(onInput: FormEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onInput != null) obj.updateDynamic("onInput")(js.Any.fromFunction1(onInput))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnInvalid(onInvalid: FormEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onInvalid != null) obj.updateDynamic("onInvalid")(js.Any.fromFunction1(onInvalid))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnKeyDown(onKeyDown: KeyboardEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onKeyDown != null) obj.updateDynamic("onKeyDown")(js.Any.fromFunction1(onKeyDown))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnKeyPress(onKeyPress: KeyboardEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onKeyPress != null) obj.updateDynamic("onKeyPress")(js.Any.fromFunction1(onKeyPress))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnKeyUp(onKeyUp: KeyboardEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onKeyUp != null) obj.updateDynamic("onKeyUp")(js.Any.fromFunction1(onKeyUp))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnLoad(onLoad: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoad != null) obj.updateDynamic("onLoad")(js.Any.fromFunction1(onLoad))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnLoadStart(onLoadStart: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoadStart != null) obj.updateDynamic("onLoadStart")(js.Any.fromFunction1(onLoadStart))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnLoadedData(onLoadedData: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoadedData != null) obj.updateDynamic("onLoadedData")(js.Any.fromFunction1(onLoadedData))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnLoadedMetadata(onLoadedMetadata: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onLoadedMetadata != null) obj.updateDynamic("onLoadedMetadata")(js.Any.fromFunction1(onLoadedMetadata))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnMouseDown(onMouseDown: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseDown != null) obj.updateDynamic("onMouseDown")(js.Any.fromFunction1(onMouseDown))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnMouseEnter(onMouseEnter: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseEnter != null) obj.updateDynamic("onMouseEnter")(js.Any.fromFunction1(onMouseEnter))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnMouseLeave(onMouseLeave: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseLeave != null) obj.updateDynamic("onMouseLeave")(js.Any.fromFunction1(onMouseLeave))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnMouseMove(onMouseMove: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseMove != null) obj.updateDynamic("onMouseMove")(js.Any.fromFunction1(onMouseMove))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnMouseOut(onMouseOut: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseOut != null) obj.updateDynamic("onMouseOut")(js.Any.fromFunction1(onMouseOut))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnMouseOver(onMouseOver: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseOver != null) obj.updateDynamic("onMouseOver")(js.Any.fromFunction1(onMouseOver))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnMouseUp(onMouseUp: MouseEvent[HTMLInputElement, NativeMouseEvent] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onMouseUp != null) obj.updateDynamic("onMouseUp")(js.Any.fromFunction1(onMouseUp))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPaste(onPaste: ClipboardEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPaste != null) obj.updateDynamic("onPaste")(js.Any.fromFunction1(onPaste))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPause(onPause: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPause != null) obj.updateDynamic("onPause")(js.Any.fromFunction1(onPause))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPlay(onPlay: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPlay != null) obj.updateDynamic("onPlay")(js.Any.fromFunction1(onPlay))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPlaying(onPlaying: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPlaying != null) obj.updateDynamic("onPlaying")(js.Any.fromFunction1(onPlaying))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerCancel(onPointerCancel: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerCancel != null) obj.updateDynamic("onPointerCancel")(js.Any.fromFunction1(onPointerCancel))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerDown(onPointerDown: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerDown != null) obj.updateDynamic("onPointerDown")(js.Any.fromFunction1(onPointerDown))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerEnter(onPointerEnter: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerEnter != null) obj.updateDynamic("onPointerEnter")(js.Any.fromFunction1(onPointerEnter))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerLeave(onPointerLeave: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerLeave != null) obj.updateDynamic("onPointerLeave")(js.Any.fromFunction1(onPointerLeave))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerMove(onPointerMove: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerMove != null) obj.updateDynamic("onPointerMove")(js.Any.fromFunction1(onPointerMove))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerOut(onPointerOut: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerOut != null) obj.updateDynamic("onPointerOut")(js.Any.fromFunction1(onPointerOut))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerOver(onPointerOver: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerOver != null) obj.updateDynamic("onPointerOver")(js.Any.fromFunction1(onPointerOver))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnPointerUp(onPointerUp: PointerEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onPointerUp != null) obj.updateDynamic("onPointerUp")(js.Any.fromFunction1(onPointerUp))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnProgress(onProgress: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onProgress != null) obj.updateDynamic("onProgress")(js.Any.fromFunction1(onProgress))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnRateChange(onRateChange: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onRateChange != null) obj.updateDynamic("onRateChange")(js.Any.fromFunction1(onRateChange))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnReset(onReset: FormEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onReset != null) obj.updateDynamic("onReset")(js.Any.fromFunction1(onReset))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnScroll(onScroll: UIEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onScroll != null) obj.updateDynamic("onScroll")(js.Any.fromFunction1(onScroll))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnSeeked(onSeeked: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSeeked != null) obj.updateDynamic("onSeeked")(js.Any.fromFunction1(onSeeked))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnSeeking(onSeeking: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSeeking != null) obj.updateDynamic("onSeeking")(js.Any.fromFunction1(onSeeking))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnSelect(onSelect: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSelect != null) obj.updateDynamic("onSelect")(js.Any.fromFunction1(onSelect))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnStalled(onStalled: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onStalled != null) obj.updateDynamic("onStalled")(js.Any.fromFunction1(onStalled))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnSubmit(onSubmit: FormEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSubmit != null) obj.updateDynamic("onSubmit")(js.Any.fromFunction1(onSubmit))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnSuspend(onSuspend: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onSuspend != null) obj.updateDynamic("onSuspend")(js.Any.fromFunction1(onSuspend))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnTimeUpdate(onTimeUpdate: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTimeUpdate != null) obj.updateDynamic("onTimeUpdate")(js.Any.fromFunction1(onTimeUpdate))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnTouchCancel(onTouchCancel: TouchEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchCancel != null) obj.updateDynamic("onTouchCancel")(js.Any.fromFunction1(onTouchCancel))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnTouchEnd(onTouchEnd: TouchEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchEnd != null) obj.updateDynamic("onTouchEnd")(js.Any.fromFunction1(onTouchEnd))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnTouchMove(onTouchMove: TouchEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchMove != null) obj.updateDynamic("onTouchMove")(js.Any.fromFunction1(onTouchMove))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnTouchStart(onTouchStart: TouchEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTouchStart != null) obj.updateDynamic("onTouchStart")(js.Any.fromFunction1(onTouchStart))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnTransitionEnd(onTransitionEnd: TransitionEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onTransitionEnd != null) obj.updateDynamic("onTransitionEnd")(js.Any.fromFunction1(onTransitionEnd))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnVolumeChange(onVolumeChange: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onVolumeChange != null) obj.updateDynamic("onVolumeChange")(js.Any.fromFunction1(onVolumeChange))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnWaiting(onWaiting: SyntheticEvent[HTMLInputElement, Event] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (onWaiting != null) obj.updateDynamic("onWaiting")(js.Any.fromFunction1(onWaiting))
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.StrictInputProps]
    }
    @scala.inline
    def withOnWheel(onWheel: WheelEvent[HTMLInputElement] => Unit): StrictInputProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
