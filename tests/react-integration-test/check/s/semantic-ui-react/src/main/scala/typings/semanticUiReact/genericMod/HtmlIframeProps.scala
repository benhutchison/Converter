...
object HtmlIframeProps {
  ...
  implicit sealed class Sugar (x: HtmlIframeProps) {
    @scala.inline
    def duplicate: HtmlIframeProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.genericMod.HtmlIframeProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): HtmlIframeProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.genericMod.HtmlIframeProps with T]
    @scala.inline
    def withStringDictionary(StringDictionary: /* key */ StringDictionary[js.Any]): HtmlIframeProps = {
      ...
      obj.asInstanceOf[typings.semanticUiReact.genericMod.HtmlIframeProps]
    }
    @scala.inline
