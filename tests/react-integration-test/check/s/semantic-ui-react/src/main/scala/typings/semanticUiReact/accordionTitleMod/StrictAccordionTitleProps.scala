...
object StrictAccordionTitleProps {
  ...
  implicit sealed class Sugar (x: StrictAccordionTitleProps) {
    @scala.inline
    def duplicate: StrictAccordionTitleProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.accordionTitleMod.StrictAccordionTitleProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): StrictAccordionTitleProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.accordionTitleMod.StrictAccordionTitleProps with T]
    @scala.inline
    def withActiveUndefined: StrictAccordionTitleProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      js.special.delete(obj, "active")
      obj.asInstanceOf[typings.semanticUiReact.accordionTitleMod.StrictAccordionTitleProps]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): StrictAccordionTitleProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
