...
object InputOnChangeData {
  ...
  implicit sealed class Sugar (x: InputOnChangeData) {
    @scala.inline
    def duplicate: InputOnChangeData = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.inputInputMod.InputOnChangeData]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): InputOnChangeData with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.inputInputMod.InputOnChangeData with T]
    @scala.inline
    def withValue(value: String): InputOnChangeData = js.Dynamic.global.Object.assign(js.Dynamic.literal(value = value.asInstanceOf[js.Any]), x).asInstanceOf[typings.semanticUiReact.inputInputMod.InputOnChangeData]
    @scala.inline
    def withAbout(about: String): InputOnChangeData = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (about != null) obj.updateDynamic("about")(about.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.semanticUiReact.inputInputMod.InputOnChangeData]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): InputOnChangeData = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
