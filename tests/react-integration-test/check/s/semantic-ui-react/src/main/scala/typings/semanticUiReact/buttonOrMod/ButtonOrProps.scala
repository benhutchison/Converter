...
object ButtonOrProps {
  ...
  implicit sealed class Sugar (x: ButtonOrProps) {
    @scala.inline
    def duplicate: ButtonOrProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.buttonOrMod.ButtonOrProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): ButtonOrProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.buttonOrMod.ButtonOrProps with T]
    @scala.inline
    def withStringDictionary(StringDictionary: /* key */ StringDictionary[js.Any]): ButtonOrProps = {
      ...
      obj.asInstanceOf[typings.semanticUiReact.buttonOrMod.ButtonOrProps]
    }
    @scala.inline
