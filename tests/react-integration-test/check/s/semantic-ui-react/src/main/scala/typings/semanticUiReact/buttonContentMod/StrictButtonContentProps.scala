...
object StrictButtonContentProps {
  ...
  implicit sealed class Sugar (x: StrictButtonContentProps) {
    @scala.inline
    def duplicate: StrictButtonContentProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.buttonContentMod.StrictButtonContentProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): StrictButtonContentProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.buttonContentMod.StrictButtonContentProps with T]
    @scala.inline
    def withAs(as: js.Any): StrictButtonContentProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (as != null) obj.updateDynamic("as")(as.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.semanticUiReact.buttonContentMod.StrictButtonContentProps]
    }
    @scala.inline
    def withChildren(children: ReactNode): StrictButtonContentProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
