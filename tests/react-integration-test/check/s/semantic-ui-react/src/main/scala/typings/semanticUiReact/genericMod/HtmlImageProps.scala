...
object HtmlImageProps {
  ...
  implicit sealed class Sugar (x: HtmlImageProps) {
    @scala.inline
    def duplicate: HtmlImageProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.genericMod.HtmlImageProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): HtmlImageProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.genericMod.HtmlImageProps with T]
    @scala.inline
    def withStringDictionary(StringDictionary: /* key */ StringDictionary[js.Any]): HtmlImageProps = {
      ...
      obj.asInstanceOf[typings.semanticUiReact.genericMod.HtmlImageProps]
    }
    @scala.inline
