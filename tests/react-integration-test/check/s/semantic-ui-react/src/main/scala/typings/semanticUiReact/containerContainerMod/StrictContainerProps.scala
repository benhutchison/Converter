...
object StrictContainerProps {
  ...
  implicit sealed class Sugar (x: StrictContainerProps) {
    @scala.inline
    def duplicate: StrictContainerProps = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.semanticUiReact.containerContainerMod.StrictContainerProps]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): StrictContainerProps with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.semanticUiReact.containerContainerMod.StrictContainerProps with T]
    @scala.inline
    def withAs(as: js.Any): StrictContainerProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
      if (as != null) obj.updateDynamic("as")(as.asInstanceOf[js.Any])
      obj.asInstanceOf[typings.semanticUiReact.containerContainerMod.StrictContainerProps]
    }
    @scala.inline
    def withChildren(children: ReactNode): StrictContainerProps = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
