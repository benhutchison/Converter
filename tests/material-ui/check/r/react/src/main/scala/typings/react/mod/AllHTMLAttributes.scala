...
object AllHTMLAttributes {
  ...
  implicit sealed class Sugar[T] (x: AllHTMLAttributes[T]) {
    @scala.inline
    def duplicate: AllHTMLAttributes[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x).asInstanceOf[typings.react.mod.AllHTMLAttributes[T]]
    @scala.inline
    def combine[T /* <: js.Any */](other: T): AllHTMLAttributes[T] with T = js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.AllHTMLAttributes[T] with T]
    @scala.inline
    def withAccept(accept: String): AllHTMLAttributes[T] = {
      ...
      obj.asInstanceOf[typings.react.mod.AllHTMLAttributes[T]]
    }
    @scala.inline
    ...
    @scala.inline
    def withChildren(children: ReactNode): AllHTMLAttributes[T] = {
      val obj = duplicate.asInstanceOf[js.Dynamic]
