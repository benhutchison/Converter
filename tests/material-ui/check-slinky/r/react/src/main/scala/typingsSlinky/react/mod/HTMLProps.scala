...
object HTMLProps {
  ...
  implicit sealed class Sugar[T] (x: HTMLProps[T]) {
    ...
    @scala.inline
    def withDefaultValue(defaultValue: foo): HTMLProps[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(defaultValue = defaultValue.asInstanceOf[js.Any]), x).asInstanceOf[typingsSlinky.react.mod.HTMLProps[T]]
    @scala.inline
    def withOnChange(onChange: foo): HTMLProps[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(onChange = onChange.asInstanceOf[js.Any]), x).asInstanceOf[typingsSlinky.react.mod.HTMLProps[T]]
    @scala.inline
    ...
    @scala.inline
    def withValue(value: foo): HTMLProps[T] = js.Dynamic.global.Object.assign(js.Dynamic.literal(value = value.asInstanceOf[js.Any]), x).asInstanceOf[typingsSlinky.react.mod.HTMLProps[T]]
    @scala.inline
